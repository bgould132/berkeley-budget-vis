function vis (data) {
    ...
    var svg = d3.select("#chart").append("svg").classed("sankeyChart", true)
    ...
    // load the data
    //d3.csv("https://bgould132.github.io/berkeley-budget-vis/Budget data/" + fy + "budget.csv", function(error, data) {
